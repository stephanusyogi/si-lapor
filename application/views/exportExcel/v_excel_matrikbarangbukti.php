<?php 
    ...
    header("Content-Disposition: attachment; filename=Laporan Matrik Barang Bukti ({$namaKesatuan}) - Periode {$dateNow}.xls");
?>
...
<table class="table table-bordered table-striped mt-2" style="font-size:0.8rem;">
