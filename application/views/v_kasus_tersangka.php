    ...
    <section class="content">
      <div class="container-fluid pt-2">
        <div class="alert alert-warning" role="alert">
          Silahkan mengisi data tersangka pada formulir dibawah ini. Harap mengisi data dengan benar dan akurat !
        </div>
                          ...
                          <ol>
                            <?php foreach ($result as $rowBB) { 
                              ...
                              <?php }else{ 
                                ...
                                ?>
                                <li>Barang bukti sama dengan tersangka a.n <?= $duplicateTSK[0]['nama'] ?> (<strong><?= $duplicateBB[0]['kategori'] ?></strong>)</li>
                              <?php } ?>
                            <?php } ?> 
                          </ol>
                        ...
                        <?php }else{ ?>
                          ...
                          <script>
                            ...
                            $('.chooseTSK<?= $row['id_tersangka'] ?>').on('change', function() {
                              ...
                              xhr.open("POST", "getBBDuplicate", true);
                              xhr.onload = () => {
                              ...
                              <form action="<?= base_url('kasus/updateTersangka'); ?>/<?= $row['id_tersangka']; ?>/<?= $dataKasus['id_kasus'] ?>" method="POST"  enctype="multipart/form-data">
                                  <div class="row">
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <label for="usia">Usia</label>
                                      <input type="number" name="usia" id="usia" class="form-control" placeholder="Masukkan Usia" value="<?= $row['usia'] ?>" required>
        ...
        <div class="py-4 d-flex justify-content-between">
            <a href="<?= base_url("lapor-ungkap-kasus/{$dataKasus['id_kasus']}") ?>" class="btn btn-secondary">Kembali ke Formulir Kasus</a>
